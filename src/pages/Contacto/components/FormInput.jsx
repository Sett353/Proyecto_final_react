    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <input
                ...
                required={required}
                className="w-full rounded-lg border border-violet-200 dark:border-violet-900 bg-violet-50 dark:bg-zinc-950 px-3 py-2.5 text-zinc-900 dark:text-violet-50 shadow-sm outline-none transition placeholder:text-zinc-500 hover:border-violet-500 focus:border-fuchsia-400 focus:bg-white dark:focus:bg-zinc-900 focus:ring-4 focus:ring-violet-200 dark:focus:ring-violet-950"
                ref={ref}
                {...rest}
            />
            {error && (
